...
describe("userErrorMessage", () => {
  ...
  it("maps validation, authorization, capacity, and availability failures to safe messages", () => {
    const cases: Array<[string, number, string]> = [
      ...
      ["MEMBER_CONTINUITY_INDEPENDENT_REVIEW_REQUIRED", 409, "errors.memberContinuityIndependentReview"],
      ["MEMBER_CONTINUITY_CROSS_COOPERATIVE_UNSUPPORTED", 409, "errors.memberContinuityCrossCooperative"],
      ["MEMBER_CONTINUITY_EVIDENCE_INVALID", 422, "errors.memberContinuityEvidence"],
      ["PERMANENT_MEMBER_CONTINUITY_ROLE_REQUIRED", 403, "errors.memberContinuityPermanentRole"],
      ["MEMBER_CONTINUITY_CASE_NOT_PENDING", 409, "errors.memberContinuityBlocked"],
      ["INDEPENDENT_CUSTODY_INVENTORY_REQUIRED", 403, "errors.custodyContinuityIndependentInventory"],
      ["INDEPENDENT_CUSTODY_APPROVER_REQUIRED", 403, "errors.custodyContinuityIndependentApproval"],
      ["CUSTODY_CONTINUITY_TARGET_REQUIRED", 403, "errors.custodyContinuityTarget"],
      ["LOT_CUSTODY_CONTINUITY_HELD", 409, "errors.custodyContinuityHeld"],
      ["CUSTODY_CONTINUITY_EVIDENCE_INVALID", 422, "errors.custodyContinuityEvidence"],
      ["CUSTODY_CONTINUITY_NOT_READY_FOR_APPROVAL", 409, "errors.custodyContinuityBlocked"],      ["MEMBER_MERGE_INDEPENDENT_REVIEW_REQUIRED", 409, "errors.memberMergeIndependentReview"],
