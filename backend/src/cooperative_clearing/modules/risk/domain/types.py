...
class AntifraudRuleCode(StrEnum):
    ...
    RELATED_ACCOUNT_RATING_RING = "RELATED_ACCOUNT_RATING_RING"
    LIMIT_SPLITTING_BURST = "LIMIT_SPLITTING_BURST"
    RISK_COEFFICIENT_CHANGE_SPIKE = "RISK_COEFFICIENT_CHANGE_SPIKE"
    RELATED_CRITICAL_RESOURCE_CONCENTRATION = "RELATED_CRITICAL_RESOURCE_CONCENTRATION"
    REPUTATION_SYNCHRONIZATION = "REPUTATION_SYNCHRONIZATION"
    CONTRIBUTION_REPUTATION_INFLUENCE = "CONTRIBUTION_REPUTATION_INFLUENCE"
    PRIVILEGED_DECISION_RELATED_PARTY = "PRIVILEGED_DECISION_RELATED_PARTY"
    AID_CAMPAIGN_SPLITTING = "AID_CAMPAIGN_SPLITTING"
    SANCTION_IDENTITY_CONTINUITY = "SANCTION_IDENTITY_CONTINUITY"
