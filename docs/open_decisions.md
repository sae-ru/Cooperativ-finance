...
### OD-033/OD-038 update после Slice 27

Slice 27 реализовал только аварийную непрерывность физической сохранности: удержание партий, независимый пересчет, временное назначение и личную приемку. OD-033 остается `OPEN` для юридического порядка собственности, полномочий представителя и внешнего подтверждения обстоятельств. OD-038 остается `OPEN` для наследников, паев, долгов, поручительств, активных сделок, репутации, персональных данных и окончательного закрытия карточки. Техническая передача хранения не является имущественным наследованием.