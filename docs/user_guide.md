...
## Аварийная передача хранения

1. Сначала в административном реестре откройте дело «Смерть или недееспособность» и получите независимое подтверждение.
2. Откройте «Склад и ответственность» -> «Аварийная передача».
3. Выберите прежнего хранителя и склад, кандидата, место, временный срок и основание.
4. Другой контролер входит под своей учетной записью, пересчитывает каждую партию и прикладывает фото или акт.
5. Другой администратор безопасности проверяет результаты и подтверждает решение кодом TOTP.
