...
## Исполняемые ограничения Slice 11

Node bond и exposure являются отдельными записями federation-контура и не дают
права автоматически списывать личные паи назначенных людей. Reservation
exposure сериализуется под database lock и ограничена active bilateral limit и
contract period. Incident/quarantine блокирует новые операции; установление
ущерба и имущественное последствие остаются отдельной процедурой с доказательством,
причинной связью, пределом и апелляцией.
