...
Статус: обязательный production-контракт; локальный baseline реализован в [Slice 7](implemented_slice_7.md). Экономические параметры требуют утверждения до пилота.
