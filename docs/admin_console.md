...
В разделе «Склад и ответственность» появилась вкладка «Аварийная передача». Администратор выбирает прежнего хранителя и кандидата, контролер пересчитывает партии, другой security-администратор принимает защищенное решение, а кандидат лично принимает временную ответственность. Один пользователь не получает несовместимые команды этапов. Технические коды причин заменены понятными RU/EN формулировками.
